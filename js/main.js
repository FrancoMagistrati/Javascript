	...
	const filtroAdidas = document.getElementById("filtroAdidas")
	const filtroUnder = document.getElementById("filtroUnder")
	const filtroPuma = document.getElementById("filtroPuma")
	...
	boton.addEventListener('click', () => agregarAlCarrito(item));
		...
		filtroAdidas.addEventListener('click', () => {
			const filtro = zapatillas.filter((el) => el.nombre.includes("Adidas"))
		...
		filtroUnder.addEventListener('click', () => {
			const filtro = zapatillas.filter((el) => el.nombre.includes("Under"))
		...
		filtroPuma.addEventListener('click', () => {
			const filtro = zapatillas.filter((el) => el.nombre.includes("Puma"))
